...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="MSU-IIT STUDENT INFORMATION SYSTEM", font=("Arial", 30))
        label.place(x=230,y=20)

        home = tk.Button(self, text="HOME",font=("Arial",16,"bold"),bd=0, width = 10, bg="Black", fg="white", command=lambda: controller.show(Home))
        home.place(x=380,y=300)
        home.config(cursor= "hand2")
        
        course = tk.Button(self, text="COURSES",font=("Arial",16,"bold"),bd=0, width = 10, bg="Black", fg="white", command=lambda: controller.show(Courses))
        course.place(x=568,y=300)
        course.config(cursor= "hand2")
        
        students = tk.Button(self, text="REGISTRATION",font=("Arial",16,"bold"),bd=0, width = 13, bg="Black", fg="white", command=lambda: controller.show(Students))
        students.place(x=750,y=300)
        students.config(cursor= "hand2")

        students = tk.Button(self, text="EXIT",font=("Arial",15,"bold"),bd=0, width = 10, bg="Black", fg="white", command=iExit)
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.clear = Button(self, text="CLEAR", font=('Arial', 11), height=1, width=10, bd=1, bg="Black", fg="white", command=clear)
        self.clear.place(x=460,y=420)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=('Arial', 11), height=1, width=10, bd=1, bg="Black", fg="white", command=delete_course)
        self.delete.place(x=460,y=480)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Arial', 11, 'bold'),bd=0, bg= "Black", fg="white", command=search_course)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Arial', 11, 'bold'), height=1, width=11, bg="Black", fg="white", command=display_course)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="REGISTRATION FORM ", font=("Arial", 40))
        label.place(x=130,y=20)
        
        home = tk.Button(self, text="HOME",font=("Arial",12,"bold"),bd=0, width = 7, bg="Black", fg="white",  command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        self.delete = Button(self, text="DELETE", font=('Arial', 11), height=1, width=10, bd=1, bg="Black", fg="white", command=delete_stud)
        self.delete.place(x=450,y=420)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Arial', 11, 'bold'),bd=0, bg= 'Black', fg="white", command=search_stud)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Arial', 11, 'bold'), height=1, width=11,  bg="Black", fg="white",command = display_stud)
        self.display.place(x=575,y=105)
        self.display.config(cursor= "hand2")
